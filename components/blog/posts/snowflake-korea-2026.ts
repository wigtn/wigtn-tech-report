...
export const snowflakeKorea2026: BlogPost = {
  ...
  body: [
    { t: "p", text: "Seoul, April 2026. Snowflake's AI & Data Hackathon Korea opened on March 17, ran for a month with more than 500 people taking part, and finished on April 29 with three finalists on stage in each of its two tracks. WIGTN Flake placed second in the Tech Track." },
    { t: "p", text: "This is the brief we were handed, the thing we built against it, the model decision the demo rested on, and the audit that afterwards took our own headline number from eleven down to seven." },

    { t: "h", text: "The brief, and what it would not let us do" },
    { t: "p", text: "Snowflake supplied the data and left the idea open. Four datasets came through Snowflake Marketplace (NextTrade, RichGo, SPH and AJD) and everything you built had to sit on top of them and on the Snowflake platform. You could bring your own problem. You could not bring your own warehouse." },
    { t: "p", text: "Three judging criteria: how well you used the technology, how complete the service was as a combination of data and AI, and whether it complied with security and data governance. That third one is not where a hackathon usually puts its attention, and it quietly rules out the easiest answer in the room, which is to pull everything out of the warehouse and hand it to an external model." },
    { t: "p", text: "The constraint that shaped the build most, though, was the format. The first cut was not a live demo. It was a ten-minute video. A recording judges what an audience can see happening, not what the system is technically capable of, so every design decision downstream became a decision about legibility: what appears on screen, in what order, and whether a viewer can tell that real SQL just ran." },

    { t: "h", text: "What we built" },
    { t: "p", text: "Every public-data dashboard in Korea can tell you how many people walk through Yeoksam-dong. Almost none of them will tell you where to open your cafe. The gap between a number and a decision is the actual problem, and it is not a data problem." },
    ...
    { t: "p", text: "The deck said eleven Cortex capabilities across four datasets. Afterwards, someone read the production code path end to end, and three of those claims did not survive it." },
    {
      t: "list",
      items: [
    ...
    { t: "p", text: "What is left is seven capabilities that actually run: Cortex Analyst, Cortex LLM, FORECAST, ANOMALY_DETECTION, AI_SENTIMENT, AI_CLASSIFY and data_to_chart. And three actively selected datasets: SPH, RichGo, AJD. Seven and three are the numbers on this site, on the project page, and in the tech report, and they should stay seven and three." },
    {
      t: "quote",
    ...
    { t: "h", text: "Thanks to" },
    { t: "p", text: "Snowflake Korea, for running it and for supplying the data through NextTrade, RichGo, SPH and AJD on Marketplace. A hackathon that hands you the datasets is a hackathon where the teams are actually comparable." },
    { t: "p", text: "The judges, for a rubric that put security and data governance next to technology utilization. That is not where a hackathon usually puts it, and it is a better question than the one we were braced for." },
    { t: "p", text: "And the other five finalists. A month, four shared datasets, six teams, and no two of the systems on that stage looked anything alike. That is the part worth showing up for." },
