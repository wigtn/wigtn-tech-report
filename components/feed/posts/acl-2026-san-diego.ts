...
export const aclSanDiego2026: FeedPost = {
  ...
  body: [
    { t: "p", text: "San Diego, July 2026. The acceptance email arrived back in April; the part that mattered came three months later, when WIGVO went to the ACL 2026 System Demonstrations floor as booth D3. Not a poster in a hallway. A working phone line, running all day, for three days. Alongside it we were invited to IWSLT 2026, the spoken-language-translation workshop, for an oral talk and a poster." },
    { t: "p", text: "This is what we brought, what happened, and what we are changing because of it." },

    { t: "h", text: "Arriving" },
    { t: "p", text: "The 64th Annual Meeting of the Association for Computational Linguistics, July 2–7. You get a sense of the scale before you are through the door: the whole frontage of the convention centre carries the banner, and the registration queue behind it does not stop moving for two days." },
    {
      t: "gallery",
      images: [
        {
    ...
    { t: "p", text: "The numbers we took to San Diego: 555 ms median latency from caller to callee, zero echo-induced loops across 147 completed field calls, and USD 0.28 per minute on the evaluated provider stack. Those come from 155 real calls over a live phone network, not a simulation." },

    { t: "h", text: "Three days at booth D3" },
    { t: "p", text: "The System Demonstrations track is not a poster session with a poster. You get monitors, and you are expected to run the thing. Ours showed one live call from both ends at once (the caller's side, the transcript, and the recipient's phone) while we stood next to it and explained what the gates were doing as they did it." },
    { t: "p", text: "Most demos ask you to watch. Ours asked you to talk. Visitors dialed a number, someone answered an ordinary phone, and the two of them held a conversation across a language barrier. Then they usually tried to break it: talking over each other, switching languages mid-sentence, walking away from the handset." },
    {
      t: "gallery",
      images: [
        {
    ...
    { t: "p", text: "Running it live in a loud exhibition hall was its own test, and a harsher one than the field study. The echo gate held. The dual-session design kept each direction's interpreter from bleeding into the other. And the latency stayed low enough that people stopped treating it like a walkie-talkie and just talked." },

    { t: "h", text: "Between sessions" },
    { t: "p", text: "The coffee breaks are not a break. Twice a day the hall fills, everyone queues for the same buffet, and you end up talking to whoever is next to you in line, which at ACL means the person holding the plate beside you might be the author of a paper you cited last month. More of this trip's useful conversations started in that queue than in any scheduled session." },
    {
      t: "gallery",
      images: [
        {
    ...
    { t: "p", text: "We prepared for the academic questions and we got them: the evaluation protocol, why COMET against LLM references rather than human translations, how the voice-activity thresholds were tuned. Fair questions, and the paper answers them." },
    { t: "p", text: "What we did not expect was how many people arrived from the other direction. Engineers from NVIDIA, Apple and Amazon came by and asked about the PSTN path, the per-minute cost at scale, whether it drops into an existing call center, and which language pairs are production-ready today. The NVIDIA speech group came back more than once, across both IWSLT and ACL, which by the third visit had turned into a proper conversation rather than a demo." },
    {
      t: "gallery",
      images: [
        {
    ...
    { t: "p", text: "None of those are paper questions. They are deployment questions, and being asked them by people who build this for a living was, frankly, the best part of the week." },
    {
      t: "quote",
    ...
    { t: "p", text: "IWSLT ran as a two-day workshop inside ACL, the 23rd International Conference on Spoken Language Translation, organised by ACL/ISCA SIGSLT. We were there twice over: an invited oral talk and a poster." },
    {
      t: "gallery",
      images: [
        {
    ...
    { t: "p", text: "The poster afterwards turned into a two-hour conversation with exactly the people who care most about real-time speech translation. Several had hit the same echo problem from different directions, which is the kind of exchange you cannot get from a paper alone." },
    {
      t: "gallery",
      images: [
        {
    ...
    { t: "p", text: "The social event was held on the USS Midway, the retired carrier moored on the San Diego waterfront, which the conference took over for the evening. You queue up the gangway, come out on a flight deck the length of three football pitches, and find the bar set up between the parked aircraft." },
    { t: "p", text: "It is a strange and very effective way to run a networking event. Nobody can hide at a table, the sun goes down over the harbour behind the island, and you spend three hours talking to people you would never have been introduced to in a session room." },
    {
      t: "gallery",
      images: [
        {
    ...
    { t: "p", text: "We came back with a shorter list than we expected, but a sharper one." },
    {
      t: "list",
      items: [
    ...
    { t: "p", text: "The other thing we are taking home is harder to put in a list. WIGVO stops being finished when the paper is published. It is finished when someone calls a hospital in a language they do not share, and it simply works." },

    { t: "h", text: "Thanks to" },
    { t: "p", text: "Antonios Anastasopoulos (George Mason University), IWSLT 2026 program chair, who extended the invitation that became the oral talk. There is an IWSLT half to this story only because of it." },
    { t: "p", text: "Jan Niehues (KIT) and Marcello Federico (Amazon), on the IWSLT 2026 organizing committee and in the chair respectively, for the time and the questions." },
    { t: "p", text: "The engineers who came back a second and third time rather than nodding politely and moving on. You know who you are, and you made the week." },
    { t: "p", text: "And everyone who picked up the phone at booth D3 and tried to break it. The list above is mostly your doing." },
